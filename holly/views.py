...
def admin_modules(request, category):
    ...
    items = GeneralModule.objects.filter(category__iexact=category)
...
def submit_enquiry(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # ... inside your submit_enquiry function ...
            ...
            for item in cart_items:
                EnquiryDetail.objects.create(
                    ...
                    # ADD THIS LINE: captures the specific 'Type' sent from the frontend
                    specification=item.get('specification') or item.get('type') or item.get('spec') or ''
                )
            # ... rest of function ...
